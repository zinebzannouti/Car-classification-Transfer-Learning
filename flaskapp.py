...
model = load_model('C:/Users/ALI/Desktop/Efficientnet_model.h5',custom_objects={'FixedDropout':FixedDropout(rate=0.4)})
...
def get_output():
	if request.method == 'POST':           
		...
		img_path ="C:/Users/ALI/.spyder-py3/static/" +img.filename
		img.save(img_path)
		a=img.filename     
